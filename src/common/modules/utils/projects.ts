...
export async function createProject(event: React.SyntheticEvent) {
...
export async function getProject(event: React.SyntheticEvent) {
  event.preventDefault();
...
export async function deleteProject(event: React.SyntheticEvent) {
  event.preventDefault();
